...
$(document).ready(function () {
    ...
    if (searchServiceArea.length > 0) {
        var selectizeOptions = services_list.map(function(service) {
            return {
                id: service.id,
                name: service.id + ' - ' + service.name + ' [' + app_currency_symbol + service.price + ']'
            };
        });
        ...
        searchServiceArea.selectize({
            ...
            maxOptions: 100, // Important: prevents browser freeze by limiting dropdown items
            render: {
