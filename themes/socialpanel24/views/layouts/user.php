...
<html lang="en" dir="ltr">
  <head>
    ...
    ?>
  <body class="theme-<?php echo $theme_name; ?> theme-socialpanel24-user">
    ...
    <script type="text/javascript" src="<?php echo BASE; ?>themes/socialpanel24/assets/js/swiper.min.js"></script>
    <script type="text/javascript" src="<?php echo BASE; ?>themes/socialpanel24/assets/js/socialpanel24.js"></script>
    <script type="text/javascript" src="<?php echo BASE; ?>themes/socialpanel24/assets/js/stars.js"></script>
