...
<html lang="en" dir="ltr">
  ...
  <body class="theme-<?php echo $theme_name; ?>">
    ...
    <?php include_once(APPPATH . 'views/layouts/common/page_overplay.php'); ?>
    ...
    <div class="page">
      <div class="page-main">
        ...
        <!-- Header Embedded -->
        <?php 
          // Try to load the core header using absolute path
          // If this fails, we will need to embed the code directly, but let's try path first.
          // Correct path to core header:
          $header_path = APPPATH . 'views/layouts/user/horizontal/blocks/header.php';
          if (file_exists($header_path)) {
              include $header_path;
          } else {
              echo '<div class="alert alert-danger">Header file missing: ' . $header_path . '</div>';
          }
        ?>
    ...
    <!-- Footer Embedded -->
    <?php 
        $footer_path = APPPATH . 'views/layouts/user/horizontal/blocks/footer.php';
