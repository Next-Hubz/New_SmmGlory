<?php
  $active_theme = function_exists('get_theme') ? get_theme() : '';
  $theme_general_layout = FCPATH . 'themes/' . $active_theme . '/views/layouts/general_page.php';

  if (!empty($active_theme) && file_exists($theme_general_layout)) {
    include $theme_general_layout;
    return;
  }
?>
<!doctype html>
