...
<!-- Load jQuery here for immediate usage if not loaded yet, though script.blade.php should handle it -->
                ...
                <div class="col-md-7">
                  ...
                  <div class="form-group">
                    ...
                    <select name="search_service_id" class="ajaxSearchService input-search-service form-control custom-select" placeholder="Search for...">
                      <option value=""></option>
                      <!-- Options are now populated via Selectize in client.js to prevent browser freeze with 10000+ services -->
                    </select>
                  </div>
