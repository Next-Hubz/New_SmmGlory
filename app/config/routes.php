...
// Explicitly define routes for user modules
$route['services'] = 'services';
$route['service-details'] = 'services/service_details';
$route['api'] = 'api';
$route['api/v1'] = 'api/v1'; // Assuming there is an API module
$route['tickets'] = 'tickets';
$route['add_funds'] = 'add_funds';
$route['order'] = 'order';
$route['dripfeed'] = 'dripfeed';
$route['subscriptions'] = 'subscriptions';
$route['refill'] = 'refill';
$route['affiliates'] = 'affiliates';
$route['faq'] = 'client/faq'; // Already defined above but good to be sure
$route['terms'] = 'client/terms';
...
// Since admin.php controller doesn't exist, we must route 'admin' to 'statistics' (or another dashboard)
// But we need a login page. If 'admin/login' was handled by 'admin.php', we need to find where login is.
// It seems 'auth/login' is the client login. Admin login is usually separate or the same.
// Let's check if 'auth' module handles admin login.

// Assuming 'statistics' is the dashboard
$route[$GLOBALS['ADMIN_URL_PREFIX']]                        = 'admin/statistics'; 

// We need to find the login controller. 
// If there is no 'admin.php', maybe it is 'auth.php' in admin module? No.
// Maybe 'auth' module handles both?
$route[$GLOBALS['ADMIN_URL_PREFIX'] . '/login']               = 'admin/auth/login'; // Try standard auth first
$route[$GLOBALS['ADMIN_URL_PREFIX'] . '/logout']              = 'admin/auth/logout';
$route[$GLOBALS['ADMIN_URL_PREFIX'] . '/cronjobs']            = 'admin/cronjobs/index';
$route[$GLOBALS['ADMIN_URL_PREFIX'] . '/cronjobs/index']      = 'admin/cronjobs/index';
